...
export const getMovimientos = createAsyncThunk(
  "user/getMovimientos",
...
const movimientosSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(getMovimientos.pending, (state) => {
    });
    builder.addCase(getMovimientos.fulfilled, (state, { payload }) => {
      state.loading = false;
      state.movimientos = payload;
    });
    builder.addCase(getMovimientos.rejected, (state, action: any) => {
      state.loading = false;
      console.log(action);
