...
export const getChoferes = createAsyncThunk(
  "user/getChoferes",
...
const choferesSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(getChoferes.pending, (state) => {
    });
    builder.addCase(getChoferes.fulfilled, (state, { payload }) => {
      state.loading = false;
      state.choferes = payload;
    });
    builder.addCase(getChoferes.rejected, (state, action: any) => {
      state.loading = false;
      console.log(action);
